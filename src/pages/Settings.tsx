                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked) =>
                        setSettings({
                          ...settings,
                          allowGuestRegistration: checked,
                        })
                      }
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Enable automatic webinar recording
                      </p>
                    </div>
                    <Switch
                      checked={settings.enableRecordings}
                      onCheckedChange={(checked) =>
                        setSettings({ ...settings, enableRecordings: checked })
                      }
                    />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setSettings({
                          ...settings,
                          maxWebinarDuration: parseInt(e.target.value),
                        })
                      }
                    />
                  </div>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Sync user data with HubSpot CRM
                    </p>
                  </div>
                  <Badge
                    variant={
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <Badge
                    variant={
                      integrationStatus.clicksend === "connected"
                        ? "default"
                        : "secondary"
                    }
                  >
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setSettings({
                        ...settings,
                        clicksendApiKey: e.target.value,
                      })
                    }
                  />
                </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Automatic reminders before webinars start
                    </p>
                  </div>
                  <Switch
                    checked={settings.webinarReminders}
                    onCheckedChange={(checked) =>
                      setSettings({ ...settings, webinarReminders: checked })
                    }
                  />
                </div>
