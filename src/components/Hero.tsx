  ...
  const features = [
    {
      ...
      description:
        "Crystal clear video quality with adaptive streaming for audiences of any size",
    },
    {
      icon: Users,
      title: "Interactive Engagement",
      description:
        "Built-in chat, polls, Q&A, and breakout rooms to keep your audience engaged",
    },
    {
      icon: Calendar,
      title: "Smart Scheduling",
      description:
        "Automated reminders and timezone detection ensure perfect attendance",
    },
    {
      icon: BarChart3,
      title: "Detailed Analytics",
      description:
        "Track attendance, engagement metrics, and gather actionable insights",
    },
    {
      icon: Shield,
      title: "Enterprise Security",
      description:
        "End-to-end encryption and enterprise-grade security for your peace of mind",
    },
    {
      icon: Zap,
      title: "One-Click Recording",
      description:
        "Automatically record sessions and share them instantly with your audience",
    },
  ];
          ...
          <div className="text-center space-y-8 animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <Button
                variant="outline"
                size="lg"
                className="px-8 py-6 text-lg border-primary/20 hover:border-primary/40 transition-all duration-300"
              >
                Watch Demo
              </Button>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            From scheduling to analytics, RLS Wealth Vault provides a complete
            platform for hosting engaging webinars
          </p>
        </div>
